...
/* gs_shrinky.cpp - Direct3D10-based introductory geometry shader example
...
const char * myProgramName             = "gs_shrinky",
...
HRESULT InitWindow( HINSTANCE hInstance, int nCmdShow )
{
    ...
    wcex.lpszClassName  = L"gs_shrinky";
    wcex.hIconSm        = NULL;
    ...
    g_hWnd = CreateWindow( L"gs_shrinky",          // Class name
                           L"gs_shrinky",          // Window name
