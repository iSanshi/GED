...
/* 21_bump_map_wall.c - OpenGL-based bump mapping example using Cg
   programs from Chapter 8 of "The Cg Tutorial" (Addison-Wesley, ISBN
   0321194969). */
...
static const char *myProgramName = "21_bump_map_wall",
                  *myVertexProgramFileName = "C8E1v_bumpWall.cg",
/* page 205 */    *myVertexProgramName = "C8E1v_bumpWall",
                  *myFragmentProgramFileName = "C8E2f_bumpSurf.cg",
/* page 206 */    *myFragmentProgramName = "C8E2f_bumpSurf";

static float myLightAngle = 4.0;   /* Angle light rotates around scene. */
