...
---
	...
	vstudio.pathVars = {
		...
		["file.reldirectory"]           = { absolute = false, token = "%(RelativeDir)" }, --pe:akovalovs: added this to know path to current file
		["file.directory"]               = { absolute = false, token = "%(RootDir)%(Directory)" }, --pe:akovalovs: added this to know absolute path to current file
	}
