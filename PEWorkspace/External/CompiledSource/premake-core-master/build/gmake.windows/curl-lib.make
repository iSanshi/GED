...
ifeq ($(config),release)
  ...
  DEFINES += -DPREMAKE_COMPRESSION -DPREMAKE_CURL -DNDEBUG -DBUILDING_LIBCURL -DCURL_STATICLIB -DHTTP_ONLY -DCURL_DISABLE_LDAP -DWIN32 -DUSE_SCHANNEL -DUSE_WINDOWS_SSPI
...
ifeq ($(config),debug)
  ...
  DEFINES += -DPREMAKE_COMPRESSION -DPREMAKE_CURL -D_DEBUG -DBUILDING_LIBCURL -DCURL_STATICLIB -DHTTP_ONLY -DCURL_DISABLE_LDAP -DWIN32 -DUSE_SCHANNEL -DUSE_WINDOWS_SSPI
  INCLUDES += -I../../contrib/curl/include -I../../contrib/curl/lib
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
