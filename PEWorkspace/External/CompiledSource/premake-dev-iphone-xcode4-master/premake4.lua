...
--
	...
	project "Premake4"
		targetname  "premake-dev-iphone-xcode-master" --akovalovs: changed name
		language    "C"
		kind        "ConsoleApp"
		...
		--akovalovs: modifying destination to fit into External/CompiledSource/bin-osx/premake-dev-iphone-xcode-master/debug
		configuration "Debug"
			targetdir   "../bin-osx/premake-dev-iphone-xcode-master/debug"
			defines     "_DEBUG"
			flags       { "Symbols" }
			
		configuration "Release"
			targetdir   "bin/bin-osx/premake-dev-iphone-xcode-master/release"
			defines     "NDEBUG"
			flags       { "OptimizeSize" }
