...
--
	...
	project "Premake4"
		targetname  "premake4-stable" -- akovalovs: changed name
		language    "C"
		kind        "ConsoleApp"
		...
		--akovalovs: modifying destination to fit into External/CompiledSource/bin-win/premake-stable/debug
		configuration "Debug"
			targetdir   "../bin-win/premake-stable/debug"
			defines     "_DEBUG"
			flags       { "Symbols" }
