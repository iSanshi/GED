		...
		onproject = function(prj)
			...
			for _, platform in ipairs(platforms) do
				for cfg in premake.eachconfig(prj, platform) do
					...
					-- pe-begin: akovalovs: added PSVita for completeness, PS3 from above will clean same files since uses same extensions
					premake.clean.file(prj, premake.gettarget(cfg, "build", "posix", "PSVita", "windows").fullpath)
					-- pe-end
