...
--
	...
	function vc2010.generate_filters(prj)
		...
		vc2010.header()
			...
			-- akovalovs: begin
			-- we include the shader files as part of CustomBuild, not as part of fxcompile.cgvs,cgps
			--vc2010.filefiltergroup(prj, "cgbuild_ps3_vs")
			--vc2010.filefiltergroup(prj, "cgbuild_ps3_ps")
